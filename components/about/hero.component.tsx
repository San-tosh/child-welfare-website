const Hero = ()=>{
return (
    <div className="hero-wrap" style={{backgroundImage: "url(\"bg_9.jpg\")"}} data-stellar-background-ratio="0.5">
            ...
            <div className="row no-gutters slider-text align-items-center justify-content-center"
                ...
                <div className="col-md-7 ftco-animate text-center fadeInUp ftco-animated" data-scrollax=" properties: { translateY: '70%' }">
                    <h1 className="mb-2" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
                        About Us</h1>
                    <span style={{color:'white', fontSize:'1.2rem',fontWeight:'lighter'}}>About us</span>
                </div>
            </div>
        </div>
    </div>
